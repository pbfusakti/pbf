...
class App_Model_General_DbTable_TranscriptProfileDetail extends Zend_Db_Table { //Model Class for Users Details
	...
	public function fnGetTranscriptProfileGrpSubject($idProfile,$grp) {
		...
		->join(array('c'=> 'tbl_subjectmaster'),'a.idSubject=c.idSubject',array('ShortName','IdSubject','SubjectName'=>'BahasaIndonesia','sks'=>'CreditHours','SubCode'))
	...
	public function fnGetTranscriptProfileName($idProfile) {
		...
		->joinLeft(array('b' => 'tbl_definationms'),'a.idGroup = b.idDefinition',array('grpname'=>'b.BahasaIndonesia','kategori'=>'b.BahasaIndonesia','category'=>'b.DefinitionDesc'))
		->where('a.idTranscriptProfile =?',$idProfile)
		->group('a.idGroup')
		->order('grp.order');
