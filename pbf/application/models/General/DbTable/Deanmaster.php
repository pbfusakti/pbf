...
/*		$lstrselectsql = $this->lobjDbAdpt->select()
	 ...
	 public function getCollegeDean($IdCollege,$jabatan=null) { //Function for the view University
		...
		if ($jabatan==null) $select->where('d.Jabatan is null or d.Jabatan=""');
		else $select->where('d.Jabatan=?',$jabatan);
