<?php
class Examination_Form_Cgpacalculation extends Zend_Dojo_Form { //Formclass for the user module
	public function init() {
		...
		$Cgpa = new Zend_Form_Element_Hidden('Cgpa');
		...
		$this->addElements(array(
				...
				$UpdUser,
				$Add,
				$Save,$Cgpa,$IdStudentRegistration,
				$clear
		));
