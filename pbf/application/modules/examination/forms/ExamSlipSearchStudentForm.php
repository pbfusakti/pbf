...
class Examination_Form_ExamSlipSearchStudentForm extends Zend_Form
{
	...
	public function init()
	{
		...
		//exam type
		$this->addElement('select','ass_type', array(
		...
		$this->ass_type->addMultiOption(null,"-- Please Select --");
		foreach($assessmentList as $list){
			$this->ass_type->addMultiOption($list["key"],$list["value"]);
		}
